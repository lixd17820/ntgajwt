...
public class ZhcxOneRecordListAdapter extends ArrayAdapter<QueryResultBean> {

	Activity context;

	public ZhcxOneRecordListAdapter(Activity _context, List<QueryResultBean> objects) {
